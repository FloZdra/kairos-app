  ...
  <div>
    <v-card class="overflow-hidden">
      <div class="d-flex align-end pa-3">
        <span class="text-h6 font-weight-bold text-no-wrap">Admins</span>
      </div>
      ...
      <div v-if="users.length === 0">
        <v-divider></v-divider>
        <div class="d-flex align-center pa-3 text-body-2">There are no admins</div>
      </div>
    ...
    <AddEditUser v-model="addEdit.dialog" :user="addEdit.user" role="ADMIN"></AddEditUser>
  </div>
</template>
